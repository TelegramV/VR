...
export function vrdom_instantiateVComponentVNode(node) {
    const componentInstance = new (node.component)({
        props: node.attrs,
        slot: node.slot,
    })
 ...
 * @param $node
 */
function vrdom_renderVComponentVNode(node, $node = undefined) {
